...
import { Table, Money, SkeletonTable, Badge, Button, Drawer, Modal, Input, Pagination, BulkActionBar, DateRangePicker } from '@/components/ui'
                ...
                <div key={t.id} className="flex items-center justify-between py-2.5 border-b border-gray-700 last:border-0">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      {t.user?.fullName ?? '—'}
                      {' · '}
                      <span className="font-mono">{new Date(t.createdAt).toLocaleString('ar-EG', { dateStyle: 'short', timeStyle: 'short' })}</span>
